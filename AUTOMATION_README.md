...
- **email**: Email portal (akan replace "kabarjanten@gmail.com")
- **socialHandle**: Handle social media (akan replace "kabarjanten")
- **colors**: Tema warna
  - **primary**: Warna utama kuning (contoh: #0C4A6E → custom)
  - **dark**: Warna gelap hitam (contoh: #082F49 → custom)
...
| `kabarjanten` | `siteName` (tanpa spaces) |
| `kabarjanten` | `socialHandle` |
| `kabarjanten@gmail.com` | `email` |
| `#0C4A6E` (primary) | Warna primary dari config |
| `#082F49` (dark) | Warna dark dari config |
